...
export default function App() {
  ...
  return (
    <div className={`main ${overlay}`}>
      <div className="layer">
        <div className="page">
          <label className="overlay-switch">
            Text over animation
            <input type="checkbox" name="overlay" onChange={(e) => setOverlay(e.target.checked ? 'overlay' : '')} />
          </label>
          <form>
            <label>
              Chapter 1
          ...
          <div className="window">
            <div className="chapters">
              <p>
                ...
                who avoids a pain that produces no resultant pleasure? On the other hand, we denounce with righteous
                indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment,
                so blinded by desire, that they cannot foresee the pain and trouble that are bound to ensue; and equal
                ...
                owing to the claims of duty or the obligations of business it will frequently occur that pleasures have
              ...
              <p>
                ...
                perferendis doloribus asperiores repellat. On the other hand, we denounce with righteous indignation and
              ...
              <p>
                ...
                secure other greater pleasures, or else he endures pains to avoid worse pains. But I must explain to you
                how all this mistaken idea of denouncing pleasure and praising pain was born and I will give you a
      ...
      <Canvas camera={{ position: [0, 0, 10], fov: 25 }} worker={worker} fallback={<Scene />} />
    </div>
  )
}
